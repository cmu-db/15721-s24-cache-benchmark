...
use istziio_client::storage_client::StorageClientImpl as IstziioStorageClientImpl;
use parpulse_client::client::StorageClientImpl as ParpulseStorageClientImpl;
...
pub fn setup_client_2() -> Box<dyn StorageClient> {
    ...
    Box::new(IstziioStorageClientImpl::new_for_test(
        1,
        map.clone(),
        &server_url,
        false,
